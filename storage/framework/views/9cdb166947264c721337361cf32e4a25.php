<?php $__env->startSection('title', 'Temps'); ?>
<?php $__env->startSection('page', 'temps'); ?>
        ...
        <form id="time-form" class="ticket-form" data-entity="temps">
            ...
            <div class="form-row form-row-2">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="time-date" name="date_saisie" class="form-input" required value="<?php echo e(date('Y-m-d')); ?>">
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\JUMORAS\Documents\documents2\perso\ticketing_laravel\systicket\resources\views/pages/temps/index.blade.php ENDPATH**/ ?>