...
<section class="stats-grid stats-grid-dashboard" aria-label="Indicateurs">
    <a href="<?php echo e(route('tickets.index')); ?>" class="stat-card stat-card-blue stat-card-link role-admin-collaborateur" title="Voir la liste des tickets ouverts">
    ...
    <a href="<?php echo e(route('projets.index')); ?>" class="stat-card stat-card-orange stat-card-link" title="Voir les projets actifs">
        <span class="stat-icon" aria-hidden="true">📁</span>
        <div class="stat-content">
            <div class="stat-value-wrap">
    ...
    <a href="<?php echo e(route('validations.index')); ?>" class="stat-card stat-card-green stat-card-link" title="Voir les tickets à valider">
        <span class="stat-icon" aria-hidden="true">✅</span>
        <div class="stat-content">
            <div class="stat-value-wrap">
    ...
    <a href="<?php echo e(route('temps.index')); ?>" class="stat-card stat-card-purple stat-card-link role-admin-collaborateur" title="Voir le suivi des heures">
    ...
    <div class="widget-grid widget-grid-2">
        <article class="widget-card role-admin-collaborateur">
            <header class="widget-header">
                ...
                <a href="<?php echo e(route('tickets.index')); ?>" class="link">Voir tout</a>
            </header>
            <div class="widget-content" id="dash-tickets-by-status">
                <div class="dashboard-chart-bars">
                    <?php $__currentLoopData = ['Nouveau' => 'new', 'En cours' => 'in_progress', 'Terminé' => 'done', 'À valider' => 'to_validate', 'Validé / Refusé' => 'closed']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="dashboard-chart-row">
                        <span class="dashboard-chart-label"><?php echo e($label); ?></span>
        ...
        <article class="widget-card role-admin-collaborateur">
            <header class="widget-header">
                ...
                <a href="<?php echo e(route('rapports')); ?>" class="link role-admin-only">Rapports</a>
            </header>
            ...
            <div class="widget-content">
                <table class="table table-compact">
                    ...
                    <tbody id="dash-recent-tickets">
                        <tr><td colspan="4" class="table-empty">Aucun ticket récent.</td></tr>
                    </tbody>
                </table>
            </div>
        </article>
    ...
    <div class="widget-grid widget-grid-2">
        <article class="widget-card">
            <header class="widget-header">
                ...
                <a href="<?php echo e(route('rapports')); ?>" class="link role-admin-only">Voir tout</a>
            </header>
        ...
        <article class="widget-card">
            <header class="widget-header">
                ...
                <a href="<?php echo e(route('projets.index')); ?>" class="link">Tous les projets</a>
            </header>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\JUMORAS\Documents\documents2\perso\ticketing_laravel\systicket\resources\views/pages/dashboard.blade.php ENDPATH**/ ?>