...
<?php $__env->startSection('page', 'profil'); ?>
        ...
        <form id="profile-form" class="ticket-form">
            ...
            <div class="form-row form-row-2">
                <div class="form-group">
                    ...
                    <input type="text" id="profile-nom" name="last_name" class="form-input" value="<?php echo e(auth()->user()->last_name); ?>" required>
                </div>
                <div class="form-group">
                    <label for="profile-prenom" class="form-label">Prénom</label>
                    <input type="text" id="profile-prenom" name="first_name" class="form-input" value="<?php echo e(auth()->user()->first_name); ?>" required>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label for="profile-email" class="form-label">Email</label>
                    <input type="email" id="profile-email" name="email" class="form-input form-input-readonly" value="<?php echo e(auth()->user()->email); ?>" readonly>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="tel" id="profile-telephone" name="phone" class="form-input" value="<?php echo e(auth()->user()->phone ?? ''); ?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="form-photo-container">
                        <div class="avatar avatar-large"><?php echo e(strtoupper(substr(auth()->user()->first_name, 0, 1) . substr(auth()->user()->last_name, 0, 1))); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\JUMORAS\Documents\documents2\perso\ticketing_laravel\systicket\resources\views/pages/profil.blade.php ENDPATH**/ ?>