...
<?php $__env->startSection('page', 'tickets'); ?>
...
<div class="page-header">
    ...
    <div class="page-header-right">
        <a href="<?php echo e(route('tickets.create')); ?>" class="btn btn-primary btn-create-ticket role-admin-collaborateur">+ Créer un ticket</a>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\JUMORAS\Documents\documents2\perso\ticketing_laravel\systicket\resources\views/pages/tickets/index.blade.php ENDPATH**/ ?>