...
<?php $__env->startSection('page', 'projets'); ?>
...
<div class="page-header">
    ...
    <div class="page-header-right">
        <a href="<?php echo e(route('projets.create')); ?>" class="btn btn-primary btn-create-project role-admin-collaborateur">+ Créer un projet</a>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\JUMORAS\Documents\documents2\perso\ticketing_laravel\systicket\resources\views/pages/projets/index.blade.php ENDPATH**/ ?>