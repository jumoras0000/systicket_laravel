...
<section id="report-summary" class="reports-section" aria-labelledby="report-summary-title">
    ...
    <div class="stats-grid stats-grid-reports" id="report-kpis">
        <a href="{{ route('tickets.index') }}" class="stat-card stat-card-blue stat-card-link" title="Voir les tickets">
        ...
        <a href="{{ route('temps.index') }}" class="stat-card stat-card-orange stat-card-link" title="Voir le suivi du temps">
        ...
        <a href="{{ route('projets.index') }}" class="stat-card stat-card-muted stat-card-link" title="Voir les projets">
            <span class="stat-icon" aria-hidden="true">📁</span>
            <div class="stat-content">
                <div class="stat-value-wrap">
...
<section id="report-detail" class="reports-section card" aria-labelledby="report-detail-title">
    <header class="reports-section-header">
        ...
        <a href="{{ route('temps.index') }}" class="link">Voir tout le suivi du temps →</a>
    </header>
    <div class="table-container">
